    ...
    <div className=" bg-black smpt-[120px]">
      ...
      >
            ...
            <div className="flex justify-center ">
              <div className="w-full md:w-10/12 lg:w-8/12 xl:w-6/12">
                <div className="mb-[40px]">
                  ...
                  <p className="first-letter:capitalize sm:text-[20px] text-[16px] max-w-[550px] mx-auto mb-5 flex justify-center text-center">
                    {t("footerRedefining")}
                  </p>
        ...
        <div className="pb-[20px] flex justify-center">
          <div className="container">
            <p className=" first-letter:capitalize pb-[67px] flex flex-row gap-1 justify-center sm:text-[16ps] text-[14px] ">
              ...
              <div className="capitalize">All Rights Reserved By</div>
              <a
